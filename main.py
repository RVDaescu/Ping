...
def traf2sql(host, db_name, pkt_count = 3, pkt_inter = 1, size = 1, interval = 10, repeat_nr = 100, loop = False, minor_alarm = None):
    """
    method 
    """
